...
public class Pool
{
	...
	public long special_available;
	public long special_used;
	public String[] disk_ids;
	public Topology[] topology;
	public Topology[] log;
	public String[] zil_drives;
	public Topology[] special;
    ...
    public String getTotalAvailableCapacityString() { 
        long total_available_capacity = Long.valueOf(available) + Long.valueOf(used); 
        return String.valueOf(total_available_capacity); 
    }
    public String getTotalCapacityString() { return total_capacity.toString(); }
