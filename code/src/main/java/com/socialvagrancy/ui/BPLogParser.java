	...
	public static void parseCommand(String command, String path, String output_format)
	{
		...
		switch(command)
		{
			...
			case "list-buckets":
				...
				break;
            case "list-cifs-connections":
                to_print = Controller.listCifsConnections(path);
                break;
            ...
            case "list-policies":
				...
				break;
            case "list-messages":
                to_print = Controller.listMessages(path);
                break;
            case "list-shares":
                to_print = Controller.listShares(path);
                break;
			...
			case "--version":
				...
				break;
			default:
				System.err.println("Invalid command selected: " + command + ". Please use --help or -h to see available commands.");
				break;
		}
