...
public class PoolTaskParser extends DataplannerParser
{
	...
	String read_task_2_blank = "read_from_pool_id = ,";
	...
	public void parseLine(String line)
	{
		...
		{
			if(line.contains(read_task) || (line.contains(read_task_2) && !line.contains(read_task_2_blank)))
			{
...
*/
	...
	private String searchJobIDCreation(String line)
	{
		...
		{
			System.err.println("Invalid job line: " + line);
			return "";
		}
	}
