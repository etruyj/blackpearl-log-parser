//===================================================================
// GetDataPolicies.java
// 	Description:
//		Import the rest/gui_ds3_data_policies.json into a class.
//===================================================================
...
public class GetDataPolicies
{
	public static GuiDataPolicy fromJson(String file_path)
	{
		Gson gson = new Gson();
		...
		try
		{
			if(json.length() > 0)
			{
				return gson.fromJson(json, GuiDataPolicy.class);
			}
		}
