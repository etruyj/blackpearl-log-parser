//===================================================================
// GetDS3ReplicationRules.java
// 	Description:
//		Import the rest/gui_ds3_ds3_data_replication_rules.json 
//		into a class.
//===================================================================
...
public class GetDS3ReplicationRules
{
	public static GuiDS3RepRules fromJson(String file_path)
	{
		Gson gson = new Gson();
		...
		try
		{
			if(json.length() > 0)
			{
				return gson.fromJson(json, GuiDS3RepRules.class);
			}
		}
