...
public class GatherCompletedJobDetails
{
	...
	{
		System.out.println("job_name, request_type, job_size, created_at, date_completed, duration, chunk, task_name, task_id, drive_sn, barcode, task_start, task_end, drive_loaded, exchange_start, exhange_end, write_start, write_end, size, bandwidth");
